  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Card className="h-full flex items-center justify-center p-6 shadow-none transition-all hover:bg-accent active:bg-accent dark:bg-black dark:hover:bg-accent dark:active:bg-accent cursor-pointer sm:p-8 md:p-10 min-h-[80px] sm:min-h-[100px] group">
          <CardContent className="p-0">
            <Shield className="h-6 w-6 sm:h-8 sm:w-8 md:h-6 md:w-6 animate-[iconBreathe_3s_ease-in-out_infinite] [animation-delay:1s] group-hover:animate-none group-active:animate-none transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3 group-active:scale-110 group-active:rotate-3 fill-current" />
          </CardContent>
        </Card>
      </DialogTrigger>
      <DialogContent>
