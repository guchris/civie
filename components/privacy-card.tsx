  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Card className="h-full flex items-center justify-center p-6 shadow-none transition-all hover:bg-accent dark:bg-black cursor-pointer sm:p-8 md:p-10 lg:p-4 min-h-[80px] sm:min-h-[100px] lg:min-h-0">
          <CardContent className="p-0">
            <Shield className="h-6 w-6 sm:h-8 sm:w-8 lg:h-6 lg:w-6" />
          </CardContent>
        </Card>
      </DialogTrigger>
      <DialogContent>
